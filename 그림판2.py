...
canvas.bind("<Double-Button>", draw_shape)    # 마우스 왼쪽 버튼을 누르면서 움직일 때
...
btn_canvas=Button(win,text="canvas\ncolor",bg="white",fg="black",wigth=w,height=h,command=lambda:change_tool("canvas"))

btn_pen=Button(win,text="pen\ncolor",bg="white",fg="black",wigth=w,height=h,command=lambda:change_tool("pen"))

btn_fill=Button(win,text="fill\ncolor",bg="white",fg="black",wigth=w,height=h,command=lambda:change_tool("shape"))

btn_rect  =Buton(win,text="○",bg="white",width=w,height=h,command=lambda: change_tool("oval"))

btn_tri  =Buton(win,text="□",bg="white",width=w,height=h,command=lambda: change_tool("rect"))

btn_oval  =Buton(win,text="△",bg="white",width=w,height=h,command=lambda: change_tool("tri"))
